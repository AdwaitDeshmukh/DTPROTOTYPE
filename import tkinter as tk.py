...
class ElectricityTrackerUI:
    ...
    def process(self):
        ...
        try:
            ...
            self.consumption = mainfile.extract_text(self.image_path)  # Your image processing function
            ...
            if self.consumption >= 500:
                ...
                mainfile.send_email(subject, body, email, email, password)  # Send email to the entered address
            ...
            mainfile.plot_bar_with_thresholds(self.consumption)  # Your graph plotting function
